...
export default {
  ...
  data() {
    return {
      ...
      /* rgb模式 */
      select: { state: '彩色循环模式', abbr: 'module1' },
      rgb_modules: [
        { state: '彩色循环模式', abbr: 'module1' },
        { state: '追光模式', abbr: 'module2' },
        { state: '能量模式', abbr: 'module3' },
        { state: '堆积模式', abbr: 'module4' },
        { state: '呼吸模式', abbr: 'module5' },
        { state: '渐变模式', abbr: 'module6' },
        { state: '太极旋转模式', abbr: 'module7' },
        { state: '七彩飘带模式', abbr: 'module8 不可自定义' },
      ],
      /* 亮度调节 */
      min: 0,
      max: 255,
